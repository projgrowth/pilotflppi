  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="p-8 md:p-10 max-w-7xl">
        ...
        {selectedCount > 0 && (
          <div
            className="fixed bottom-6 left-1/2 z-floating flex -translate-x-1/2 items-center gap-3 rounded-full border bg-card px-4 py-2 shadow-lg animate-in fade-in slide-in-from-bottom-2"
            role="region"
