...
export function OfflineBanner() {
  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-center gap-2 border-b border-amber-300/60 bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-900 dark:border-amber-700/40 dark:bg-amber-950/60 dark:text-amber-200">
